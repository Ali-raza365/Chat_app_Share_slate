...
export default function ShowComment({ navigation, route, bid, Comments }) {
  ...
  return (
    <View>
      <Block space="between" row style={{ marginVertical: 20,}}>
...
<Block>
  <TouchableOpacity onPress={()=>navigation.navigate("ShowAllComment")}>
  <Text
            style={{
              fontFamily: "open-sans-regular",
              alignSelf: "center",
      ...
      {CommentsHere?.length == (0 || undefined)?<Text style={{ marginBottom: 100 }}>No comments yet</Text>:
<ScrollView
            ...
            <Block style={styles.coment_user} key={index}>
              ...
              >
                ...
                >
                  ...
                  >
                    <Text
                      style={{ fontFamily: "open-sans-bold", marginRight: 30 }}
                      muted
                      size={14}
                      color={argonTheme.COLORS.TEXT}
                    >
